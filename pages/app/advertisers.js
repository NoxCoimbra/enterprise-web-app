            ...
            <div className="flex flex-col gap-8 pr-10">
                ...
                <div className="flex flex-col gap-8">
                    ...
                    <div className="flex flex-row gap-6">
                        <AdvertiserTables tableSize = {"small"} tableName={"Handles"} list ={handleList}/>
                        <AdvertiserTables tableSize = {"big"} tableName={"Advertisers"} list ={advertiserList}/>
                    </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                    {advertiserList.map((item) => (
                        ...
                        <AdvertiserTables tableSize = {"medium"} tableName={item.name} list ={advertiserList}/>
                        </div>
                    ))}
                </div>
            </div>
